...
echo * 한국어 패치가 풀릴 때마다 백업을 실행해주세요.
...
copy "%GLOBAL_PATH%\game\sqpack\ffxiv\0a0000.win32.index" "%~dp0\backup\"
copy "%GLOBAL_PATH%\game\sqpack\ffxiv\0a0000.win32.dat0" "%~dp0\backup\"
